...
export const setToken = (token, expirationDate) => {
  ...
  Cookie.set(authKey, "yes", { expires: 9999, secure: true  });
  Cookie.set(userKey, jwtDecode(token), { expires: expirationDate, secure: true });
  Cookie.set(jwtKey, token, { expires: expirationDate, secure: true });
};
