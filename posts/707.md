...
permalink: /post/707
summary: >-
  A dead-simple, self-hosted CSP and Reporting API endpoint. Collect client-side
  errors and violations easily. Free to use and open source.
---
...
I hope you enjoy the service. It's free. If you want another service that is supported by a large organization and is much nicer, check out [report-uri.com](https://web.archive.org/web/20260109084536/https://report-uri.com/).
