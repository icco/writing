...
permalink: /post/421
summary: >-
  Migrated my blog's asset pipeline to Webpack. Initial impressions are
  positive, but the documentation needs work. Here's my experience.
---

Last night I sat down and finally [fixed my blog](https://github.com/icco/natnatnat/pull/7/files). Since Google App Engine removed Golang support from the gcloud binary[^gcloud-tool], I haven't been able to deploy updates to my blog. I also haven't been happy with how the app is structured, nor how assets were managed.
...
[^gcloud-tool]: Their tool for deploying code and interacting with Google Cloud properties from the command line.
