...
permalink: /post/579
summary: >-
  Catching up after a missed update. Working on enki.garden file indexing,
  Forgetful text capture, and a list of neglected projects.
---
...
I also worked on [Forgetful](https://github.com/icco/forgetful), and got a basic service that took any text you highlighted in OS X[^automator] and wrote it to a simple web server. It has no authentication or what not, but it's a simple service running locally now.

## Projects I didn't touch:

 - [Today](https://web.archive.org/web/20180611035045/https://github.com/icco/today)
 - [longplay.club](https://github.com/icco/longplay.club)
 - [locative.garden](https://web.archive.org/web/20160502132600/https://github.com/icco/locative.garden)
...
[^json-size]: About 30Mb compressed.

[^automator]: Using [Automator](http://thenextweb.com/lifehacks/2011/06/07/how-to-create-mac-os-x-services-with-automator/).
