...
permalink: /post/703
summary: >-
  A look at the core beliefs that drive my decisions and actions, including why
  sharing information is vital and building tools matters.
---
...
I've had these up for a while, but in August, I came across [someone else's Manifesto](https://web.archive.org/web/20230324191140/https://hex22.org/wiki/manifesto/). I really liked how they added a few extra sentences about why each bullet point was important. I started writing this post, linked to it on the my about page, and then never finished nor published it. Now that it's December, I figure I should actually finish this post.
...
An example of how this affects what I do on a day to day can be seen on my [Talks](https://web.archive.org/web/20220126223452/https://natwelch.com/talks) and [Writing](https://web.archive.org/web/20220126235611/https://natwelch.com/writing) pages.
...
* I write code for [Fog](https://web.archive.org/web/20191201220000/https://fog.io/), a Ruby library for working with cloud infrastructure.
