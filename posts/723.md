...
permalink: /post/723
summary: >-
  A blog rewrite born from COVID quarantine and a Bermuda wedding. Exploring
  contentlayer, NextJS 13's app router, and the inevitable bugs.
---
...
I'm pretty happy with how it turned out, but I have no doubt there are a few bugs.[^rss-feed] If you come across something missing, please file a bug at https://github.com/icco/writing/issues or email me at nat@natwelch.com

Thanks!

[^rss-feed]: I thought I made the rss feed identical, but I apparently did not, for example.
