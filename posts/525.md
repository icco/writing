...
So yeah, whatever I end up learning at Hacker School, you'll be able to find stuff about it [here](https://web.archive.org/web/http://pseudoweb.net/archives), on [writing.natwelch.com](https://writing.natwelch.com/) and on [GitHub](https://github.com/icco).
