...
permalink: /post/525
summary: >-
  Reflecting on my time at Google, why I left after nearly four years, and my
  search for a better fit through travel and a new focus on personal projects.
---

Friday, March 20th, 2015 was my last day at Google. I worked there for three years and eight months. I spent the majority of my time working on [Google Compute Engine](https://techcrunch.com/2012/06/28/google-compute-engine/), but also worked on [Google Offers](https://en.wikipedia.org/wiki/Google_Offers) and "Punchd by Google".[^punchd-google]
...
So yeah, whatever I end up learning at Hacker School, you'll be able to find stuff about it [here](https://writing.natwelch.com/), on [writing.natwelch.com](https://writing.natwelch.com/) and on [GitHub](https://github.com/icco).

[^punchd-google]: The incarnation of [Punchd](https://getpunchd.com/) post-acquisition inside of Google's Mobile Apps Lab.
