...
permalink: /post/686
summary: >-
  Diving into the tech behind rebuilding my blog (again!). This time with
  Next.js, Apollo, and GraphQL. Exploring the backend with gqlgen and Go.
---
...
> Before we get too deep into this article though: I don't normally run ads, but hey, I wrote a book, buy it, please? [Real World SRE on Amazon](https://amzn.to/2Tc2D2g) or at [Packt](https://web.archive.org/web/20200810022506/https://www.packtpub.com/web-development/real-world-sre).
...
You can play around yourself at [graphql.natwelch.com](https://web.archive.org/web/20240420032512/https://graphql.natwelch.com/), which has the schema [schema.graphql](https://web.archive.org/web/20260109182428/https://github.com/icco/graphql/blob/91850667a786970ba9be15c444339f843fe32ddb/schema.graphql).
...
A resolver for the above `post()` method might look like [resolver.go#L116-L128](https://web.archive.org/web/20260109182801/https://github.com/icco/graphql/blob/304854148d55ff9a4327a5cdfb31f1d5bca40175/resolver.go). Basically just a function that goes to the database, gets the data, shoves it into an object and returns it. If you had an ORM, you could probably make this code even spiffier.
