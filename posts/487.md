...
permalink: /post/487
summary: >-
  Automate weekly summaries of your Delicious (del.icio.us) bookmarks using a
  simple Bash script. Learn how to parse the API and format the output.
---
...
source, located at [my GitHub](https://github.com/icco/re-delicious).
