...
- Played https://boardgamegeek.com/boardgame/311900/votes-women and it's a delight. Lots of fun, and learned a ton of history. A bit complicated to setup, but once it's going makes total sense.