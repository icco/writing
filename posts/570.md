...
permalink: /post/570
summary: >-
  Hitting a wall on my open-source Heroku-like platform. Brainstorming
  deployment workflows: Packer, Docker Swarm, Nomad, and the quest for a viable
  pipeline.
---
...
So I want to build a heroku clone, using as much already written software as possible, but without using anything proprietary or any full packaged solutions.[^deps]
...
## Projects I didn't touch:
 ...
 - [locative.garden](https://web.archive.org/web/20160403230516/https://github.com/icco/locative.garden)
...
[^deps]: By proprietary I mean things like [Google Cloud Container Builder](https://cloud.google.com/container-builder/docs/) or [Amazon Elastic Load Balancers](https://aws.amazon.com/elasticloadbalancing/). By full packaged solutions I mean things like [Deis](http://deis.io/) or [CloudFoundry](https://www.cloudfoundry.org/).
