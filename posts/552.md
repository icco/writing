...
permalink: /post/552
summary: >-
  Quick update on my various side projects. This week was mostly note-taking and
  brainstorming, covering everything from Android apps to text-based games.
---
...
https://www.highly.co/ is the closest thing to what I want to build, but I don't think I want it to be a chrome extension. Need to figure out how much I want to store, but the minimum is the highlight, where it's from, when it was stored, and notes about the highlight.
 ...
 - [locative.garden](https://web.archive.org/web/20160229042928/https://github.com/icco/locative.garden)
