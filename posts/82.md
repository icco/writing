...
permalink: /post/82
summary: >-
  First impressions of NYC: navigating the subway, exploring museums and
  Bushwick street art, and sketching out goals for the 101-day adventure.
---
...
I'm trying to nail down what I want to get done in the first month in NYC (three weeks of which will be in HS/RC) and some goals for the first week at school. Here's a rough sketch of what I'm leaning towards so far in [OKR](https://web.archive.org/web/20250512170309/https://medium.com/startup-tools/okrs-5afdc298bc28) form:
...
## Work on projects combining Art and Programming
 ...
 - Build a tree generator.[^tree-gen]
...
[^hs-rename]: Hacker School had [announced a name change to "Recurse Center"](https://www.recurse.com/blog/77-hacker-school-is-now-the-recurse-center).

[^tree-gen]: Something that creates pictures that look like renderings of some of the sculptures in my aforementioned Flickr set.
